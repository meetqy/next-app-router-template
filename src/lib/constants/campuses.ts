...
const CAMPUS_DETAIL_OVERRIDES: Record<string, Partial<CampusProfile>> = {
	...
	"花千集校区": {
		...
		gallery: [
			{ src: "/校区/花千集校区/环境1.jpg", alt: "花千集校区教学环境一", width: 1320, height: 975 },
			{ src: "/校区/花千集校区/环境2.jpg", alt: "花千集校区教学环境二", width: 1320, height: 1748 },
			{ src: "/校区/花千集校区/环境3.jpg", alt: "花千集校区教学环境三", width: 1320, height: 1742 },
			{ src: "/校区/花千集校区/环境4.jpg", alt: "花千集校区教学环境四", width: 1320, height: 1301 },
		],
		infoStatus: "complete",
		intro:
	...
	"八里校区": {
		...
		entranceImages: [
			{ src: "/校区/八里校区/门头1.jpg", alt: "八里校区门头一", width: 1320, height: 982 },
			{ src: "/校区/八里校区/门头2.jpg", alt: "八里校区门头二", width: 1320, height: 970 },
			{ src: "/校区/八里校区/门头3.jpg", alt: "八里校区门头三", width: 1320, height: 1739 },
		],
		gallery: [
			{ src: "/校区/八里校区/环境1.jpg", alt: "八里校区环境一", width: 1320, height: 978 },
			{ src: "/校区/八里校区/环境2.jpg", alt: "八里校区环境二", width: 1320, height: 977 },
			{ src: "/校区/八里校区/环境3.jpg", alt: "八里校区环境三", width: 1320, height: 978 },
			{ src: "/校区/八里校区/环境4.jpg", alt: "八里校区环境四", width: 1320, height: 988 },
			{ src: "/校区/八里校区/环境5.jpg", alt: "八里校区环境五", width: 1320, height: 981 },
			{ src: "/校区/八里校区/环境6.jpg", alt: "八里校区环境六", width: 1320, height: 971 },
		],
		infoStatus: "complete",
		mapHref: createAmapSearchHref("成都市成华区双建路7号2层210号"),
		mapLinks: [
			{ href: createAmapSearchHref("成都市成华区双建路7号2层210号"), label: "高德地图" },
			{ href: createTencentSearchHref("成都市成华区双建路7号2层210号"), label: "腾讯地图" },
		],
		operationType: "direct",
		programImages: [
			{ src: "/校区/八里校区/服务1.jpg", alt: "四年级奥数班服务展示一", width: 1320, height: 978 },
			{ src: "/校区/八里校区/服务2.jpg", alt: "艺考培训服务展示二", width: 1320, height: 975 },
			{ src: "/校区/八里校区/服务3.jpg", alt: "儿童语言中心服务展示三", width: 1320, height: 984 },
			{ src: "/校区/八里校区/服务4.jpg", alt: "课堂笔记辅导服务展示四", width: 1320, height: 977 },
			{ src: "/校区/八里校区/服务5.jpg", alt: "八里校区课程服务展示五", width: 1197, height: 879 },
			{ src: "/校区/八里校区/服务6.jpg", alt: "八里校区课程服务展示六", width: 1194, height: 886 },
			{ src: "/校区/八里校区/服务7.jpg", alt: "八里校区课程服务展示七", width: 1193, height: 633 },
		],
		programs: [
			{ title: "四年级奥数班", description: "" },
			{ title: "艺考培训", description: "" },
			{ title: "儿童语言中心", description: "" },
			{ title: "课堂笔记辅导", description: "" },
		],
		subtitle: "直营旗舰校区",
		title: "戴氏教育（科大旗舰校区）",
	...
	"广都校区": {
		...
		entranceImages: [
			{ src: "/校区/广都校区/门头1.png", alt: "广都校区门头一", width: 1440, height: 1080 },
			{ src: "/校区/广都校区/门头2.png", alt: "广都校区门头二", width: 2000, height: 1500 },
			{ src: "/校区/广都校区/门头3.png", alt: "广都校区门头三", width: 1707, height: 1280 },
		],
		gallery: Array.from({ length: 11 }, (_, index) => ({
			src: `/校区/广都校区/环境${index + 1}.png`,
			alt: `广都校区教学环境${index + 1}`,
			width: [1279, 1706, 1707, 2048, 1500, 2016, 1707, 1707, 1707, 1707, 2000][index],
			height: [1706, 1279, 1280, 1536, 2000, 1512, 1280, 1280, 1280, 1280, 1500][index],
		})),
		infoStatus: "complete",
		mapHref: createAmapSearchHref("成都市高新区新裕路467号1栋2层附218号"),
		mapLinks: [
			{ href: createAmapSearchHref("成都市高新区新裕路467号1栋2层附218号"), label: "高德地图" },
			{ href: createTencentSearchHref("成都市高新区新裕路467号1栋2层附218号"), label: "腾讯地图" },
		],
		operationType: "direct",
		programs: [
			{ title: "课后辅导", description: "" },
			{ title: "小学", description: "" },
			{ title: "高中课程辅导", description: "" },
			{ title: "兴趣爱好", description: "" },
			{ title: "初中课程", description: "" },
			{ title: "高中辅导", description: "" },
		],
		programImages: [],
		subtitle: "直营校区",
		title: "戴氏教育（高新直营总校）",
	...
	"基地校区": {
		...
		entranceImages: [
			{ src: "/校区/基地校区/门头1.png", alt: "基地校区门头一", width: 1440, height: 1080 },
			{ src: "/校区/基地校区/门头2.png", alt: "基地校区门头二", width: 1536, height: 2048 },
			{ src: "/校区/基地校区/门头3.png", alt: "基地校区门头三", width: 1080, height: 1440 },
		],
		gallery: [
			...Array.from({ length: 10 }, (_, index) => ({
				src: `/校区/基地校区/环境${index + 1}.jpg`,
				alt: `基地校区教学环境${index + 1}`,
				width: [1707, 1706, 1920, 1707, 1702, 1707, 1707, 4096, 1702, 1706][index],
				height: [1280, 1279, 1080, 1280, 1276, 1280, 1280, 3072, 1276, 1279][index],
			})),
			{ src: "/校区/基地校区/环境11.png", alt: "基地校区教学环境11", width: 1706, height: 1280 },
		],
		infoStatus: "complete",
		mapHref: createAmapSearchHref("成都市金牛区解放路一段168号1栋3层301号、4层401号"),
		mapLinks: [
			{ href: createAmapSearchHref("成都市金牛区解放路一段168号1栋3层301号、4层401号"), label: "高德地图" },
			{ href: createTencentSearchHref("成都市金牛区解放路一段168号1栋3层301号、4层401号"), label: "腾讯地图" },
		],
		operationType: "direct",
		programImages: Array.from({ length: 6 }, (_, index) => ({
			src: `/校区/基地校区/课程${index + 1}.png`,
			alt: `基地校区课程服务${index + 1}`,
		})),
		programs: [
			{ title: "高中全科辅导", description: "" },
			{ title: "高三全日制", description: "" },
			{ title: "高考复读", description: "" },
			{ title: "升学规划", description: "" },
		],
		subtitle: "直营校区",
		title: "戴氏教育高考中心（基地旗舰校）",
		updatedAt: "2026-08-21",
	},
	"戛纳校区": {
		address: "成都市天府新区华阳滨河路二段368号戛纳湾畔1栋2层1203、1204号",
		entranceImages: [
			{ src: "/校区/戛纳校区/门头1.png", alt: "戛纳校区门头一", width: 2048, height: 1536 },
			{ src: "/校区/戛纳校区/门头3.png", alt: "戛纳校区门头三", width: 500, height: 375 },
			{ src: "/校区/戛纳校区/门头4.png", alt: "戛纳校区门头四", width: 2048, height: 1536 },
		],
		gallery: Array.from({ length: 8 }, (_, index) => ({
			src: `/校区/戛纳校区/环境${index + 1}.png`,
			alt: `戛纳校区教学环境${index + 1}`,
			width: [1080, 1500, 1500, 1500, 1500, 2080, 1500, 2304][index],
			height: [1920, 2000, 2000, 2000, 2000, 1560, 2000, 1728][index],
		})),
		infoStatus: "complete",
		mapHref: createAmapSearchHref("成都市天府新区华阳滨河路二段368号戛纳湾畔1栋2层1203、1204号"),
		mapLinks: [
			{ href: createAmapSearchHref("成都市天府新区华阳滨河路二段368号戛纳湾畔1栋2层1203、1204号"), label: "高德地图" },
			{ href: createTencentSearchHref("成都市天府新区华阳滨河路二段368号戛纳湾畔1栋2层1203、1204号"), label: "腾讯地图" },
		],
		operationType: "direct",
		programImages: Array.from({ length: 8 }, (_, index) => ({
			src: `/校区/戛纳校区/课程${index + 1}.jpg`,
			alt: `戛纳校区课程服务${index + 1}`,
		})),
		programs: [
			{ title: "艺考文化课", description: "" },
			{ title: "秋季班", description: "" },
			{ title: "初中辅导", description: "" },
			{ title: "英语辅导", description: "" },
			{ title: "升学规划", description: "" },
			{ title: "高中辅导", description: "" },
			{ title: "小学辅导", description: "" },
		],
		subtitle: "直营旗舰校区",
		title: "戴氏教育（戛纳湾旗舰校区）",
		updatedAt: "2026-08-21",
